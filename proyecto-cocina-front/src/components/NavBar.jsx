...
import muffinIcon from '../assets/muffingIcon.png'
import { Link } from 'react-router-dom'
import { GlobalContext } from '../Context'

const navigation = [
  { name: 'Recetas', to: '/Recetas', current: true }
]
        ...
        {({ open }) => (
            ...
            <Disclosure.Panel className="sm:hidden">
                ...
                {navigation.map((item) => (
                    <Disclosure.Button
                        key={item.name}
                        as={Link}           // Usa el componente Link en lugar de "a"
                        to={item.to}      // Define la ruta en la propiedad "to"
